...
class Tree extends React.BaseComponent {
  constructor(props) {
    super();
    ...
    this.treeData = props;
    this.state = {time: CIRCLEDELAY};
    this._bind('componentWillReceiveProps', 'updateCircles', 'updateTrackingText',
               'pulseFoundCircle', 'resetCirclesDisplay', 'handleSearchStart',
               'handleSearchDone', 'treeSearch')
    this.componentWillReceiveProps(treeData);
  }
...
/* handleSearchDone: post-search UI cleanup */
  ...
  render() {
    ...
    return (
      <TreeInputs
        onSelectStart = this.handleSearchStart
        onSelected = this.setTime
        onResetAll = this.resetCirclesDisplay
      />
